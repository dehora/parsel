...
class Config:
    def __init__(self):
        ...
        self.config_data = {}
        self.config_data['conf_path'] = os.path.expanduser("/etc/parsel/")
        # noinspection PyBroadException
        try:
            self.config_parser.add_section('instance')
            self.config_parser.add_section('mause')
        except:
            pass
    ...
    def parse_supplied_userdata(self, instance_data):
        ...
        parser.add_option("--mirror_cluster_name", action="store", type="string", dest="mirror_cluster_name",
                          default="noop", help="Kafka mirror cluster name")
