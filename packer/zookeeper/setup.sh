...
sudo echo "python parsel/nedry/rund/motd.py" | sudo tee -a  /home/ubuntu/.profile
...
echo && echo "Configuring /etc/init.d/init-parsel-zookeeper.sh"
echo "---------------------------------------------------------------"
sudo mv /tmp/init-parsel-zookeeper.sh /etc/init.d/
sudo chmod 777 /etc/init.d/init-parsel-zookeeper.sh
sudo chmod 755 /etc/init.d/init-parsel-zookeeper.sh
sudo update-rc.d -f init-parsel-zookeeper.sh start 99 2 3 4 5 .
